...
import java2.application_target_list.core.responses.SearchTargetByDescriptionResponse;
import java2.application_target_list.core.validators.SearchTargetByDescriptionValidator;
...
public class SearchTargetByDescriptionServiceTest extends TestCase {
    ...
    @InjectMocks SearchTargetByDescriptionService service;
    ...
    public void shouldSearchTargetsByDescription() {
        ...
        Mockito.when(database.findByTargetDescription("description")).thenReturn(targets);
