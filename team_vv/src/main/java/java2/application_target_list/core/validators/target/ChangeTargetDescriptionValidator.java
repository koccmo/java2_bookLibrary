...
public class ChangeTargetDescriptionValidator {
    ...
    public List<CoreError> validate(ChangeTargetDescriptionRequest request, TargetDatabase targetDatabase) {
        List<CoreError> errors = new ArrayList<>();

        if (!targetDatabase.isIdInTargetList(request.getTargetIdToChange())){
