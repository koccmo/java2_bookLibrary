...
public class SearchTargetByNameController {
    ...
    @GetMapping(value = "/target/searchTargetByName")
    public String showSearchTargetByNamePage(ModelMap modelMap) {
        modelMap.addAttribute("request", new SearchTargetByNameRequest());
        return "target/searchTargetByName";
    }

    @PostMapping("/target/searchTargetByName")
    public String processSearchTargetByNameRequest(@ModelAttribute(value = "request") SearchTargetByNameRequest searchTargetByNameRequest,
                                   ModelMap modelMap) {
