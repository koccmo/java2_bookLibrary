...
public class AddRecordToListController {
    ...
    @GetMapping(value = "/board/addRecordToList")
    public String showAddRecordToListPage(ModelMap modelMap) {
        ...
        return "board/addRecordToList";
    }

    @PostMapping("/board/addRecordToList")
    public String processAddRecordToListRequest(@ModelAttribute(value = "request") AddRecordRequest addRecordRequest,
                                   ModelMap modelMap) {
