...
public class AllCategoriesPagingService {
    ...
    private void calculatePagesQuantity() {
        ...
        if ((allCategoriesCount % recordsCountOnPage) == NO_EXTRA_PAGE) {
            pagesQuantity = (int) allCategoriesCount / recordsCountOnPage;
        } else {
            pagesQuantity = ((int) allCategoriesCount / recordsCountOnPage) + PAGE_OFFSET;
        }
    }
