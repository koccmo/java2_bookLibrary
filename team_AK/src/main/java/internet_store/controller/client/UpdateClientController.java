...
import internet_store.core.service.client.UpdateClientAddNewChangesService;
...
public class UpdateClientController {
    ...
    @Autowired
    UpdateClientAddNewChangesService updateService;
    @Autowired
    ...
    public String clientUpdate(@ModelAttribute(value = "client") Client client, ModelMap modelMap) {
        ...
        updateService.execute(new AddClientRequest(client, clientRepository));
