...
public class CategoryTwoPagingServiceTest {
    ...
    public void onlyOnePage() {
        Mockito.when(productRepository.getLimitsProductsCategoryTwo(6, 0)).thenReturn(new ArrayList<>());
        Mockito.when(productRepository.getCategoryTwoCount()).thenReturn(1L);
    ...
    public void twoPages() {
        Mockito.when(productRepository.getLimitsProductsCategoryTwo(6, 0)).thenReturn(new ArrayList<>());
        Mockito.when(productRepository.getCategoryTwoCount()).thenReturn(7L);
    ...
    public void threePages_Press_Next() {
        Mockito.when(productRepository.getLimitsProductsCategoryTwo(6, 0)).thenReturn(new ArrayList<>());
        Mockito.when(productRepository.getCategoryTwoCount()).thenReturn(15L);
