...
import dental_clinic.core.services.user.DeleteUserService;
...
public class BlockUserController {
    ...
    void initialize( ) {
        blockButton.setOnAction(event -> {
            ...
            Long idLong;
            try {
                idLong = Long.parseLong(id.getText());
                DeleteUserRequest deleteUserRequest = new DeleteUserRequest(idLong);
                ...
                if (!deleteUserResponse.hasErrors()) {
                    ...
                    try {
                        root = FXMLLoader.load(getClass().getResource("/FXML/blockUserUser.fxml"));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
