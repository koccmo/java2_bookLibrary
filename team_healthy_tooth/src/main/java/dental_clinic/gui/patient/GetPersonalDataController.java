...
import dental_clinic.core.services.patient.GetPersonalDataService;
...
public class GetPersonalDataController {
    ...
    @Autowired
    private GetPersonalDataService getPersonalDataService;
    ...
    void initialize( ) {
        enterButton.setOnAction(event -> {
            ...
            try {
                ...
                GetPersonalDataRequest getPersonalDataRequest = new GetPersonalDataRequest(longId);
                GetPersonalDataResponse getPersonalDataResponse = getPersonalDataService.execute(getPersonalDataRequest);
                if (!getPersonalDataResponse.hasErrors()) {
                    try {
