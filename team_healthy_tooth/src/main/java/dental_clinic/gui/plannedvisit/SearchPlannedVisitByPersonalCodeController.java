...
public class SearchPlannedVisitByPersonalCodeController {
    ...
    void initialize( ) {
        enterButton.setOnAction(event -> {
            ...
            Parent root = null;
            try {
                SearchPlannedVisitsByPersonalCodeRequest searchPlannedVisitsByPersonalCodeRequest =
                        new SearchPlannedVisitsByPersonalCodeRequest(personalCode.getText());
                SearchPlannedVisitsByPersonalCodeResponse searchPlannedVisitsByPersonalCodeResponse =
                        searchPlannedVisitsByPersonalCodeService.execute(searchPlannedVisitsByPersonalCodeRequest);
