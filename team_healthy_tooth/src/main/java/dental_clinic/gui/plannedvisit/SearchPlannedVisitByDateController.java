        ...
        enterButton.setOnAction(event -> {
            ...
            try {
                SearchPlannedVisitsByDateRequest searchPlannedVisitsByDateRequest =
                        new SearchPlannedVisitsByDateRequest(Integer.parseInt(dayFrom.getText()),
                                Integer.parseInt(dayTo.getText()), Integer.parseInt(monthFrom.getText()),
                                Integer.parseInt(monthTo.getText()));
                SearchPlannedVisitsByDateResponse searchPlannedVisitsByDateResponse =
                        searchPlannedVisitsByDateService.execute(searchPlannedVisitsByDateRequest);
