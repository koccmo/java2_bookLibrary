...
public class ChangePlannedVisitDateController {
    ...
    void initialize( ) {
        enterButton.setOnAction(event -> {
            ...
            try {
                ...
                ChangePlannedVisitTimeRequest changePlannedVisitTimeRequest =
                        new ChangePlannedVisitTimeRequest(parsedId, visitDate.getText());
