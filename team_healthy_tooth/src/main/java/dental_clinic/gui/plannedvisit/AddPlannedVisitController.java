...
public class AddPlannedVisitController {
    ...
    void initialize( ) {
        enterButton.setOnAction(event -> {
            ...
            Parent root = null;
            try {
                Long id = Long.parseLong(doctorsId.getText());
                AddPlannedVisitRequest addPlannedVisitRequest = new AddPlannedVisitRequest(visitDate.getText(), personalCode.getText(), id);
