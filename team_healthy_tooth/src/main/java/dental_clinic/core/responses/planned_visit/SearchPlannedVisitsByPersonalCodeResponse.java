...
public class SearchPlannedVisitsByPersonalCodeResponse extends CoreResponse {

    private List<PlannedVisit> plannedVisitList;

    public SearchPlannedVisitsByPersonalCodeResponse(List<PlannedVisit> plannedVisitList) {
        this.plannedVisitList = plannedVisitList;
    }

    public SearchPlannedVisitsByPersonalCodeResponse(List<CoreError> errors, List<PlannedVisit> plannedVisitList) {
        super(errors);
    }
