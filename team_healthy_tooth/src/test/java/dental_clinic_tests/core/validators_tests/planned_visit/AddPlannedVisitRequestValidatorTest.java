...
public class AddPlannedVisitRequestValidatorTest {
    ...
    public void testNotValidDateFormat() {
        ...
        AddPlannedVisitRequest addPlannedVisitRequest = new AddPlannedVisitRequest("25 01 12 15:20", personalData);
    ...
    public void testNotValidDate() {
        ...
        AddPlannedVisitRequest addPlannedVisitRequest = new AddPlannedVisitRequest("30-02-2021 15:20", personalData);
        List <CoreError> actualErrors = addPlannedVisitRequestValidator.validate(addPlannedVisitRequest);
    ...
    public void testEmptyName(){
        ...
        AddPlannedVisitRequest addPlannedVisitRequest = new AddPlannedVisitRequest("25-02-2025 15:30", personalData1);
