...
@Component
public class FindReaderByPersonalCodeUICommand implements UICommand {
    ...
    public void execute() {
        ...
        FindReadersRequest request = new FindReadersRequest("", "", readerPersonalCode,ordering, paging);
