INSERT INTO book(bookTitle,bookAuthor,bookPrice,yearOfBookIssue)
VALUES("aaa","aaa",10.00,2001);

INSERT INTO book(bookTitle,bookAuthor,bookPrice,yearOfBookIssue)
VALUES("bbb","bbb",11.00,2001);

INSERT INTO book(id,bookTitle,bookAuthor,bookPrice,yearOfBookIssue)
VALUES(3,"ccc","ccc",12.00,2002);

INSERT INTO book(id,bookTitle,bookAuthor,bookPrice,yearOfBookIssue)
VALUES(4,"ddd","ddd",13.00,2002);

INSERT INTO book(id,bookTitle,bookAuthor,bookPrice,yearOfBookIssue,page_count,description)
...
INSERT INTO reader(id,first_name,last_name)
VALUES(3,"ccc","ccc");
