...
public class ApplicationContext {
    ...
    public ApplicationContext() {
        ...
        beans.put(AddProductUIAction.class, new AddProductUIAction(
                getBean(AddProductService.class)));
        beans.put(DeleteByIdUIAction.class, new DeleteByIdUIAction(
                getBean(DeleteByProductIdService.class)));
