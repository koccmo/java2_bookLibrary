package teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after;

import java.util.Scanner;

import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.console_ui.AddBookUIAction;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.console_ui.ExitUIAction;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.console_ui.GetAllBooksUIAction;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.console_ui.RemoveBookUIAction;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.console_ui.UIAction;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.database.Database;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.database.InMemoryDatabaseImpl;
import teacher.lesson_2_single_responsibility_principle.homework.step_4_srp_level_layer.after.services.AddBookService;
