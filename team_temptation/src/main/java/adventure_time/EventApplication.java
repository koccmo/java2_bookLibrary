...
import adventure_time.dependencies.DIApplicationContextBuilder;
import adventure_time.dependencies.EventApplicationContext;
...
public class EventApplication {
    ...
    private static EventApplicationContext eventsApplication = new DIApplicationContextBuilder().build("adventure_time");
//    private static EventApplicationContext eventsApplication = new EventApplicationContext();
