...
public class DIDependencyResolver {
    ...
    public void resolve(EventApplicationContext applicationContext,
    ...
    private void tryToSetDependency(EventApplicationContext applicationContext, Object diInstance, Field field) {
