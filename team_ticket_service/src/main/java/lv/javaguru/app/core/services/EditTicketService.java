...
//
		...
		database.getTicketById(database.getCurrentPerson(), request.getId()).setDeparture(request.getDepartureCity());
	...
	public EditTicketDestinationResponse execute (EditTicketDestinationRequest request) {
		...
		database.getTicketById(database.getCurrentPerson(), request.getId()).setDestination(request.getDestinationCity());
	...
	public EditTicketDepartureDateResponse execute (EditTicketDepartureDateRequest request) {
		...
		database.getTicketById(database.getCurrentPerson(), request.getId()).setDepartDate(request.getDepartureDate());
	...
	public EditTicketReturnDateResponse execute (EditTicketArrivalDateRequest request) {
		...
		database.getTicketById(database.getCurrentPerson(), request.getId()).setReturnDate(request.getReturnDate());
	...
	public EditTicketSeatResponse execute (EditTicketSeatRequest request) {
		...
		database.getTicketById(database.getCurrentPerson(), request.getId()).setSeat(request.getSeat());
